...
for i in $(seq 1 12); do cat "tests-old/${i}.in" | python tests-generator/modify.py > "tests/${i}.in" ; done

for i in $(seq 1 12); do cat "tests/${i}.in" | python solutions/python3/solution.py > "tests/${i}.out" ; done
